...
public class ListingActivity : Activity
{
    private List<string> _promptList = new List<string>
    {
        ...
        "Who are you personal heroes?"
    };
    private List<string> _userList = new List<string>();
    private string _description = "This activity will help you reflect on the good things in your life, by asking you to list as many things as you can in a certain area.";
